...
/**
 * This is common interface for objects holding {@link Seb} and adds {@link Seb}
 * specific methods directly in scope of {@link Page}, {@link SebElement} and
 * {@link Logic}.
 */
public interface SebContext extends SearchContext, PropertySource, DataSource, WrapsDriver {
	...
	/**
	 * Returns actual page or null if Seb has no page initiated.
	 * 
	...
	/**
	 * Returns actual page casted to given type or null if Seb has no page
	 * initiated.
	 * 
	 * @param page
	 *            The class to cast the page to
	 * @return The actual page or null
	 */
	...
	/**
	 * Constructs new wait instance using default waiting settings with specific
	 * clock to use when measuring the timeout, specific sleeper to use to put
	 * the thread to sleep between evaluation loops, specific timeout in seconds
	 ...
	 * @param timeout
	 *            The timeout before waiting ends.
	 * @param retryInterval
	 *            The retry interval for delays between condition check.
	...
	/**
	 * Constructs new wait instance using default waiting settings with specific
	 * timeout in seconds and retry interval in seconds.
	 * 
	 * @return The wait instance
	 */
	...
	/**
	 * Check if actual page is a given class. It performs no other redirection
	 * or verification.
	 * 
	 * @param page
	 *            The class to check the page against
	...
	/**
	 * Asserts that actual page is a given class. It performs no other
	 * redirection or verification. Throws {@link AssertionError} if condition
	 * did not pass.
	 * 
	 * @param page
	 *            The class to check the page against
	...
	/**
	 * Safely go to page defined by class. Page is automatically verified
	 * against its conditions. If verification fails null is returned.
	 * 
	 * @param page
	 *            The page class to go to
	...
	/**
	 * Safely go to already constructed page. Page is automatically verified
	 * against its conditions. If verification fails null is returned.
	 * 
	 * @param page
	 *            The page instance to go to
	...
	/**
	 * Safely initialize page defined by class. It stays on same URL and tries
	 * to initialize the page. Page is automatically verified against its
	 * conditions. If verification fails null is returned.
	 * 
	 * @param page
	 *            The page class to initialize
	 * @return The page instance or null if page is not verified
	 */
	...
	/**
	 * Safely initialize already constructed page. It stays on same URL and
	 * tries to initialize the page. Page is automatically verified against its
	 * conditions. If verification fails null is returned.
	 * 
	 * @param page
	 *            The page instance to initialize
	 * @return The same page instance or null if page is not verified
	 */
	...
	/**
	 * Safely initialize first of matching page. Pages can be defined as class
	 * or as {@link Page} instances. It iterates over all pages and tries to
	 * initialize and verify them. First verified page is returned. If none of
	 * the pages is verified null is returned.
	 * 
	 * @param pages
	 *            The page classes or pages to initialize
	...
	/**
	 * Go to page defined by class. Page is automatically verified against its
	 * conditions.
	 * 
	 * @param page
	 *            The page class to go to
	 ...
	 *             if page verification did not pass after initialization
	 */
	...
	/**
	 * Go to already constructed page. Page is automatically verified against
	 * its conditions.
	 * 
	 * @param page
	 *            The page instance to go to
	...
	/**
	 * Initialize page defined by class. It stays on same URL and tries to
	 * initialize the page. Page is automatically verified against its
	 * conditions.
	 * 
	 * @param page
	 *            The page class to initialize
	...
	/**
	 * Initialize already constructed page. It stays on same URL and tries to
	 * initialize the page. Page is automatically verified against its
	 * conditions.
	 * 
	 * @param page
	...
	/**
	 * Initialize first of matching page. Pages can be defined as class or as
	 * {@link Page} instances. It iterates over all pages and tries to
	 * initialize and verify them. First verified page is returned. If none of
	 * the pages is verified {@link VerificationException} is thrown.
	 * 
	 * @param pages
	 *            The page classes or pages to initialize
	 * @return The same page instance
	 * @throws VerificationException
	 *             if none of pages did not pass verification after
	 *             initialization
	 */
	...
	/**
	 * Initialize element defined by class. It injects this instance as context
	 * into element.
	 * 
	 * @param element
	 *            The element class to initialize
	 * @param webElement
	 *            The web element to wrap
	 * @param optional
	 *            Is element optional
	...
	/**
	 * Construct element defined by class. It injects this instance as context
	 * into element.
	 * 
	 * @param element
	 *            The element class to construct
	 * @param webElement
	 *            The web element to wrap
	 * @param optional
	 *            Is element optional
	 ...
	 * 
	 * @param logic
	 *            The logic instance to initialize
	...
	/**
	 * Initialize elements annotated with {@link FindBy} and similar
	 * annotations.
	 */
	...
	/**
	 * Checks if element exists on actual page. If is present it does nothing.
	...
	/**
	 * Returns true if element exists on actual page. It is opposite to
	 * {@link SebContext#isNotPresent(WebElement)}.
	 * 
	 * @param element
	 *            The element to test
	...
	/**
	 * Returns true if element does not exists on actual page. It is opposite to
	 * {@link SebContext#isPresent(WebElement)}.
	 * 
	 * @param element
	 *            The element to test
	...
	/**
	 * Saves string into named file with extension. It uses
	 * {@link Seb#getFilePath(String, String)}. If {@link Seb#isReported()} is
	 * <code>false</code> no file is saved.
	 * 
	 * @param content
	 *            The string content to save.
	 * @param name
	...
	/**
	 * Saves bytes into named file with extension. It uses
	 * {@link Seb#getFilePath(String, String)}. If {@link Seb#isReported()} is
	 * <code>false</code> no file is saved.
	 * 
	 * @param bytes
	...
	/**
	 * Saves file into named file with extension. It uses
	 * {@link Seb#getFilePath(String, String)}. If {@link Seb#isReported()} is
	 * <code>false</code> no file is saved.
	 * 
	 * @param file
	 ...
	 * @return A list of all {@link SebElement}s, or an empty list if nothing
	 *         matches
	 */
	...
	/**
	 * Find all elements within the current context using the given mechanism as
	 * instances of the given {@link SebElement} or its subclass.
	 * 
	 * @param by
	 *            The locating mechanism to use
	 * @param elementCls
	 ...
	 *         {@link SebElement} or its subclass, or an empty list if nothing
	 *         matches
	 */
	...
	/**
	 * Find all elements within the given context using the given mechanism as
	 * instances of the given {@link SebElement} or its subclass.
	 * 
	 * @param context
	 *            The Seb context to search in
	...
	/**
	 * Find the first element within the current context using the given
	 * mechanism.
	 * 
	 * @param by
	...
	/**
	 * Find the first element within the given context using the given
	 * mechanism.
	 * 
	 * @param context
	 *            The Seb context to search in
	...
	/**
	 * Find the first element within the current context using the given
	 * mechanism as instance of the given {@link SebElement} or its subclass.
	 * 
	 * @param by
	 *            The locating mechanism
	 * @param elementCls
	 *            The element class
	 * @return The first matching element on the current context as instance of
	 *         the given {@link SebElement} or its subclass
	 * @throws NoSuchElementException
	 *             If no matching elements are found
	 */
	 ...
	 * @param elementCls
	 *            The element class
	 * @return The first matching element on the given context as instance of
	 *         the given {@link SebElement} or its subclass
	 * @throws NoSuchElementException
	 *             If no matching elements are found
	 */
	...
	/**
	 * Find the first element within the given context using the given mechanism
	 * as instance of the given {@link SebElement} or its subclass. If optional
	 * is <code>true</code> and no matching elements are found <code>null</code>
	 ...
	 *            The element class
	 * @param optional
	 *            <code>true</code> for returning <code>null</code> instead of
	 *            throwing {@link NoSuchElementException} if no matching
	 *            elements are found
	 * @return The first matching element on the given context as instance of
	 *         the given {@link SebElement} or its subclass
	 * @throws NoSuchElementException
	 *             If no matching elements are found and optional is
	 *             <code>false</code>
	 */
	...
	/**
	 * Find the first element within the current context using the given
	 * mechanism. To check if element is present use
	 * {@link SebElement#isPresent()} on returned value.
	 * 
	 * @param by
	 *            The locating mechanism
	 * @return The first matching element on the current context
	...
	/**
	 * Find the first element within the current context using the given
	 * mechanism as instance of the given {@link SebElement} or its subclass. To
	 * check if element is present use {@link SebElement#isPresent()} on
	 * returned value.
	 * 
	 * @param by
	 *            The locating mechanism
	...
	/**
	 * Find the first element within the given context using the given mechanism
	 * as instance of the given {@link SebElement} or its subclass. To check if
	 * element is present use {@link SebElement#isPresent()} on returned value.
	 * 
	 * @param context
	 *            The Seb context to search in
	 * @param by
	...
	/**
	 * Creates {@link ElementLocator} used to locate element. It uses
	 * {@link FindBy} and similar annotations assigned to the given field to
	 * create {@link By} locating mechanism.
	 * 
	 * @param field
	 *            The field used as locator source
	...
	/**
	 * Creates {@link ElementLocator} used to locate element. It uses the given
	 * {@link By} locating mechanism.
	 * 
	 * @param by
	 *            The locating mechanism
	 * @return The element locator
	...
	/**
	 * Creates {@link ElementLocator} used to locate element. It uses the given
	 * {@link By} locating mechanism. Set lookupCached to <code>true</code>
	 * return element from cache on further calls.
	 * 
	 * @param by
	 *            The locating mechanism
	 * @param lookupCached
	...
	/**
	 * Returns object instance with set of methods which support both browser
	 * with native dialogs and headless browsers without this capability.
	 * 
